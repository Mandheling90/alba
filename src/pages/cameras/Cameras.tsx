...
const Cameras: FC = (): React.ReactElement => {
  ...
  const clientDisplaySize = 2.5
  const [clientDisplay, setClientDisplay] = useState(clientDisplaySize)
  ...
  const handleClientWidth = () => {
    clientDisplay === clientDisplaySize ? setClientDisplay(0) : setClientDisplay(clientDisplaySize)
  }

  return (
    <StandardTemplate title={'카메라 관리'}>
      <Grid container spacing={2}>
        <Grid item xs={clientDisplay}>
          <TextField
            size='small'
            sx={{ mb: 5, display: clientDisplay != 0 ? 'block' : 'none' }}
            value={''}
      ...
      <Grid container spacing={2}>
        <Grid
          item
          xs={clientDisplaySize}
          sx={{ height: 'calc(100vh - 64px)', overflowY: 'auto', display: clientDisplay != 0 ? 'block' : 'none' }}
        >
          <Card>
            <CustomTable
        ...
        <Grid item xs={12 - clientDisplay}>
          ...
          <Grid sx={{ height: '50vh', overflowY: 'auto' }}>Grid 2</Grid>
        </Grid>
      </Grid>
    </StandardTemplate>
  )
